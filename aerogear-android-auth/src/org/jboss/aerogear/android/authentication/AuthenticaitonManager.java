 ...
 * @author Summers
 */
public class AuthenticaitonManager {
    ...
    static {
        ...
        AuthenticaitonManager.registerConfigurationProvider(HttpBasicAuthenticationConfiguration.class, basicConfigurationProvider);
        ...
        AuthenticaitonManager.registerConfigurationProvider(HttpDigestAuthenticationConfiguration.class, digestConfigurationProvider);
    }

    private AuthenticaitonManager() {
    }
     ...
     * @param name the name of the AuthenticationModule given in {@link AuthenticaitonManager#config(java.lang.String, java.lang.Class) }
     *
